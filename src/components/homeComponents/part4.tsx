...
function Feature() {
  ...
  return (
    <div className="flex flex-col items-center py-10">
      ...
      <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-bold text-indigo-900 mb-4 text-center">Featured Books</h1>

        <Slider {...settings}>
          {books.map((book: any, index) => (
            <div key={index}>
                <div className="flex justify-between sm:justify-between md:justify-around lg:justify-around xl:justify-around m-4 gap-8">
                    <div className="p-2 bg-white shadow-lg rounded-lg"><img src={book.image} alt={book.name} className="rounded-xl m-auto h-60 w-60 sm:h-60 md:h-72 lg:h-80 xl:h-96 object-center" loading="lazy" /></div>
