...
return(
    ...
    <div className="bg-[rgb(250, 245, 239)] my-10 w-full flex justify-center">
        ...
        <div className="bg-primary flex flex-col gap-3 justify-center items-center w-[80%] m-auto p-20 mx-10 mb-20">
            ...
            <button className="bg-primary px-1 py-2 text-white rounded-r-xl">SUBSCRIBE</button></div>
        </div>
