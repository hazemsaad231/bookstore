...
const Offer = () => {
    ...
    return (
        <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row justify-around items-center bg-gradient-to-r from-red-100 to-white-100 p-10 rounded-xl m-10">
