...
const Offer = () => {
    ...
    return (
        <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row justify-around items-center p-2 rounded-xl my-4" style={{ backgroundColor: 'rgb(250, 245, 239)' }}>
            <div className="flex flex-col justify-center items-center">
                ...
                <p className="text-gray-500 w-full p-2 sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/2 m-2 text-center">
            ...
            <img src={offer} alt="" className="w-96 sm:w-96 md:w-1/2 lg:w-1/2 xl:w-1/2 rounded-xl mt-10 object-cover" loading="lazy"/>
        </div>
    );
};
