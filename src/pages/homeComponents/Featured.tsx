          ...
          {books.map((book: any, index: number) => (
            <SwiperSlide key={index} className="h-full">
              <div className="group relative h-full bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 ease-out border border-slate-100 overflow-visible mt-8 mb-4 mx-2">
                ...
                <div className="relative -mt-12 mx-auto w-52 h-72 shadow-lg rounded-lg overflow-hidden transform group-hover:-translate-y-4 transition-all duration-500 z-10">
                  <img
                    src={book.image}
                    alt={book.name}
