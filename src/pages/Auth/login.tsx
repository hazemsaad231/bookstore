...
<button type="submit" className='bg-indigo-700 text-white p-2.5 rounded-lg mt-4'
 onClick={handleSubmit(onSubmit)}>{loading ? "Loading..." : "Login"}</button>

<button className='border border-indigo-700 p-2.5 rounded-lg  mt-4 text-indigo-700 hover:bg-indigo-100'
